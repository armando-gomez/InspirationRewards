...
public class SaveProfileAsyncTask extends AsyncTask<String, Void, String> {
	private static final String TAG = "SaveProfileAsyncTask";
	...
	SaveProfileAsyncTask(EditProfileActivity editProfileActivity) {
	...
	protected void onPostExecute(String s) {
		if(responseCode == 200) {
			editProfileActivity.editProfileAsyncSuccess(s);
		} else {
			editProfileActivity.editProfileAsyncError(s);
		}
	}
	...
	protected String doInBackground(String... strings) {
		...
		try {
			profileJSON = new JSONObject(strings[0]);
